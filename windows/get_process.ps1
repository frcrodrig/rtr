...
[PSCustomObject]@{Id=$_.Id;Name=$_.Name;StartTime=if($_.StartTime){$_.StartTime.ToFileTimeUtc()}else{$null};
WorkingSet=$_.WorkingSet;CPU=$_.CPU;HandleCount=$_.HandleCount;Path=$_.Path}}
