...
$Obj=Get-Volume -EA 0|?{$_.DriveLetter}|select DriveLetter,FileSystemLabel,FileSystem,SizeRemaining|%{
$NtPath = $K32::QueryDosDevice("$($_.DriveLetter):",$StrBld,65535);[PSCustomObject]@{
DriveLetter=$_.DriveLetter;FileSystemLabel=$_.FileSystemLabel;FileSystem=$_.FileSystem;
SizeRemaining=$_.SizeRemaining;NtPath=$StrBld.ToString()}}
